    ...
    <div class="apollo-example">
        ...
        >
            ...
            <div slot-scope="{ result: { data } }">
                <template v-if="data">
                    <div
                            v-for="message of data.pathfind"
                            :key="message.id"
                            class="message"
                            @click="onClickButton(message.path)"
                    >
                        <v-icon v-if="message.ext==='folder'">{{mdiFolder}}</v-icon>
                        {{ message.name }}
                    </div>
                </template>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onClickButton(pathdir) {
                this.$emit('setfolder', pathdir)
            },
